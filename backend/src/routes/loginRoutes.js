...
const { loginController } = require("../controllers/loginController.js"); //Use o mesmo nome da função exportada no controller

// definimos a rota POST para /login, que vai chamar a função loginController quando receber uma requisição
